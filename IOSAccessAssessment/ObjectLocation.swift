...
//            headingStatus = "Heading: \(headingDegrees) degrees"
    ...
    func getDepth(sharedImageData: SharedImageData) {
        guard let objectSegmentation = sharedImageData.objectSegmentation else { return }
...
//        print("depth: \(depth)")
    ...
    func calcLocation(sharedImageData: SharedImageData) {
        getDepth(sharedImageData: sharedImageData)
        guard let depth = self.depthValue else {
            print("depth: nil")
            return
        }
